...
#define FOS_LOG_DEBUG(...) logWrite(FOS, LOG_DEBUG, __FILE__, __LINE__, __VA_ARGS__);
#define FOS_LOG_INFO(...) logWrite(FOS, LOG_INFO, __FILE__, __LINE__, __VA_ARGS__);
#define FOS_LOG_WARNING(...) logWrite(FOS, LOG_WARNING, __FILE__, __LINE__, __VA_ARGS__);
#define FOS_LOG_ERROR(...) logWrite(FOS, LOG_ERROR, __FILE__, __LINE__, __VA_ARGS__);
#define FOS_LOG_FATAL(...) logWrite(FOS, LOG_FATAL, __FILE__, __LINE__, __VA_ARGS__);

#define NSE_LOG_DEBUG(...) logWrite(NSE, LOG_DEBUG, __FILE__, __LINE__, __VA_ARGS__);
#define NSE_LOG_INFO(...) logWrite(NSE, LOG_INFO, __FILE__, __LINE__, __VA_ARGS__);
#define NSE_LOG_WARNING(...) logWrite(NSE, LOG_WARNING, __FILE__, __LINE__, __VA_ARGS__);
#define NSE_LOG_ERROR(...) logWrite(NSE, LOG_ERROR, __FILE__, __LINE__, __VA_ARGS__);
#define NSE_LOG_FATAL(...) logWrite(NSE, LOG_FATAL, __FILE__, __LINE__, __VA_ARGS__);
